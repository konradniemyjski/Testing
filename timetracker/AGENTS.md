...
- Keep documentation language consistent with the existing mix of Polish and English already present in the repo. Use english to backend and Polish to front for users. 
